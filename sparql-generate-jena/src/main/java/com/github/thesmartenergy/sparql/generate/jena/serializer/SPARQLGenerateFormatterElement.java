 ...
 */
public class SPARQLGenerateFormatterElement extends SPARQLGenerateFormatterBase implements SPARQLGenerateElementVisitor {
...
//    public static boolean PATTERN_FINAL_DOT = false ;
    ...
    public void visit(ElementSource el) {
        out.print("SOURCE ");
        SPARQLGenerateFmtUtils.printNode(out, el.getSource(), context);
