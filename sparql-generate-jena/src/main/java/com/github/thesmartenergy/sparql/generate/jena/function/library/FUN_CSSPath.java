...
public class FUN_CSSPath extends FunctionBase2 {
    ...
    public static final String URI = SPARQLGenerate.FUN + "CSSPath";
...
//            org.jsoup.nodes.Document htmldoc = Jsoup.parse(sourceHtml, "", Parser.xmlParser());
            ...
            LOG.debug("No evaluation of " + html + ", " + query, ex);
            throw new ExprEvalException("No evaluation of " + html + ", " + query, ex);
        }
    }
