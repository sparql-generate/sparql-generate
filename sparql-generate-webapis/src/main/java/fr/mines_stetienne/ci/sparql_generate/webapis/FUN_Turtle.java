...
/**
 * Binding function
 * <a href="http://w3id.org/sparql-generate/fn/Turtle">fun:Turtle</a> returns
 * the RDF Dataset default graph serialized as Turtle.
 *
 * @author Maxime Lefrançois
 */
public final class FUN_Turtle implements Function {

	private static final Logger LOG = LoggerFactory.getLogger(FUN_Turtle.class);
