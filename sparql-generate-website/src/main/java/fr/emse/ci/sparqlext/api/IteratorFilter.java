...
public class IteratorFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if(functionName.equals("")) {
            redirection = contextPath+"apidocs/fr/emse/ci/sparqlext/iterator/library/package-summary.html";
        } else {
            redirection = contextPath+"apidocs/fr/emse/ci/sparqlext/iterator/library/ITER_"+functionName+".html";
        }
