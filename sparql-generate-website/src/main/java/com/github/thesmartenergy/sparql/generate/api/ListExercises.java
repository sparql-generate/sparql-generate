...
public class ListExercises extends HttpServlet {
    ...
    public Response doGet() throws IOException, URISyntaxException {
        File exercises = new File(ListExercises.class.getClassLoader().getResource("tutorial").toURI());
    ...
    public Response doGet(@PathParam("id") String id) throws IOException, URISyntaxException, Exception {
        File dir = new File(ListExercises.class.getClassLoader().getResource("tutorial/" + id).toURI());
