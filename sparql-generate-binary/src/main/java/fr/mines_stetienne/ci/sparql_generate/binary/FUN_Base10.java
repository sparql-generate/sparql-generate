...
/**
 * Binding function
 * <a href= "http://w3id.org/sparql-generate/fn/base10">base10</a> returns a
 ...
 */
public class FUN_Base10 extends FunctionBase1 implements FUN_Bytes {

	public static final String URI = SPARQLExt.FUN + "base10";

	@Override
	public NodeValue exec(NodeValue argument1) {
		Bytes b1 = getBytes(argument1);
		return new NodeValueInteger(b1.toBigInteger());
	}
