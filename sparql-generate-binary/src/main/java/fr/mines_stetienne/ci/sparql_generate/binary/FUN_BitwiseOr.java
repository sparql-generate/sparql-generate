 ...
 * "http://w3id.org/sparql-generate/fn/bitwiseOr">fun:bitwiseOr</a>
 ...
 */
public class FUN_BitwiseOr extends FunctionBase2 implements FUN_Bytes {

	public static final String URI = SPARQLExt.FUN + "bitwiseOr";
	...
	public NodeValue exec(NodeValue argument1, NodeValue argument2) {
		...
		return getNodeValue(b1.or(b2), datatype);
	}
