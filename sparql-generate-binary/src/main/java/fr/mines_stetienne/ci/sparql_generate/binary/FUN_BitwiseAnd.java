 ...
 * "http://w3id.org/sparql-generate/fn/bitwiseAnd">fun:bitwiseAnd</a>
...
public class FUN_BitwiseAnd extends FunctionBase2 implements FUN_Bytes {
	...
	public static final String URI = SPARQLExt.FUN + "bitwiseAnd";
	...
	public NodeValue exec(NodeValue argument1, NodeValue argument2) {
		...
		return getNodeValue(b1.and(b2), datatype);
	}
