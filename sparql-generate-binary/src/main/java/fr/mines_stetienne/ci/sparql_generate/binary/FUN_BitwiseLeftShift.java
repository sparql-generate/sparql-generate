 ...
 * "http://w3id.org/sparql-generate/fn/bitwiseLeftShift">fun:bitwiseLeftShift</a>
 ...
 */
public class FUN_BitwiseLeftShift extends FunctionBase2 implements FUN_Bytes {

	public static final String URI = SPARQLExt.FUN + "bitwiseLeftShift";
	...
	public NodeValue exec(NodeValue argument, NodeValue shiftCount) {
		...
		return getNodeValue(b.leftShift(shiftCountInt), datatype);
	}
