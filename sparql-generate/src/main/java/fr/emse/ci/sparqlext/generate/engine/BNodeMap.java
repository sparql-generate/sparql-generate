...
public class BNodeMap {
    ...
    /**
     * Constructs a new blank node mapping from a query solution.
     *
     * @param parent -
     * @param variables -
     * @param values -
    ...
    public BNodeMap(
            ...
            final Collection<Var> variables,
            final Collection<Binding> values) {
        this(parent);
        ...
        for(Var v : variables) {
            for(Binding binding : values) {
                ...
                if(n != null && n.isBlank() && !parent.contains(n) && !bNodeMap.containsKey(n)) {
